...
export default function Footer() {
  return (
    <>
      <div>
        <footer className="bg-nf_green px-2 sm:px-3 py-8 w-full flex items-center justify-between mt-auto relative z-10 min-h-min">
          <div>
        ...
        {/* <footer className="relative z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20 min-h-max">
